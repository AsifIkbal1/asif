...
const Signinbasic = () => {
  ...
  const fetchData = async () => {
    try {
      const response = await axios.post('https://crimsoncup.dma-bd.com/cms/auth/login/');
                    ...
                    <div className="box-body !p-[3rem]">
                        ...
                        <div className="grid grid-cols-12 gap-y-4">
                            ...
                            <div className="xl:col-span-12 col-span-12 grid mt-2">
                                <Link to={`${import.meta.env.BASE_URL}dashboards/analytics/`} className="ti-btn ti-btn-primary !bg-primary !text-white !font-medium">Sign In</Link>
                            </div>
                        </div>
