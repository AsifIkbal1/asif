                            ...
                            <div className="box">
                                <div className="box-body">
                                    <div className="flex flex-wrap items-center justify-between">
                                        <div>
                                            <h6 className="font-semibold text-primary mb-3 text-[1rem]">Total Users</h6>
                            ...
                            <div className="box overflow-hidden">
                                <div className="box-body mb-4">
                                    <div className="flex items-center justify-between">
                                        <div>
                                        <h6 className="font-semibold text-success  mb-3 text-[1rem]">Active Cards</h6>
                                        <span className="text-[1.5625rem] font-semibold">8240</span>
                                        <span className="block text-success text-[0.75rem]">+0.59<i className="ti ti-trending-up ms-1 inline-flex"></i></span>
                                        </div>
                                        <div>
                        ...
                        <div className="xl:col-span-4 lg:col-span-4 md:col-span-4 sm:col-span-6 col-span-12">
                            <div className="box overflow-hidden">
                                <div className="box-body mb-4">
                                    <div className="flex items-center justify-between">
                                        <div>
                                        <h6 className="font-semibold text-danger mb-3 text-[1rem]">Inactive Cards</h6>
                                        <span className="text-[1.5625rem] font-semibold">240</span>
                        ...
                        <div className="xl:col-span-4 lg:col-span-4 md:col-span-4 sm:col-span-6 col-span-12">
                            <div className="box">
                                <div className="box-body">
                                    <div className="flex items-center justify-between">
                                        <div>
                                            <h6 className="font-semibold text-info mb-3 text-[1rem]">Lifetime Total</h6>
                        ...
                        <div className="xl:col-span-4 lg:col-span-4 md:col-span-4 sm:col-span-6 col-span-12">
                            <div className="box">
                                <div className="box-body">
                                    <div className="flex items-center justify-between">
                                        <div>
                                            <h6 className="font-semibold text-success mb-3 text-[1rem]">Lifetime Earn</h6>
                                            <span className="text-[1.5625rem] font-semibold">12,240</span>
                        ...
                        <div className="xl:col-span-4 lg:col-span-4 md:col-span-4 sm:col-span-6 col-span-12">
                            <div className="box">
                                <div className="box-body">
                                    <div className="flex items-center justify-between">
                                        <div>
                                            <h6 className="font-semibold text-danger mb-3 text-[1rem]">Lifetime Burn</h6>
                                            <span className="text-[1.5625rem] font-semibold">12,240</span>
                        ...
                        <div className="xl:col-span-4 lg:col-span-4 md:col-span-4 sm:col-span-6 col-span-12">
                            <div className="box">
                                <div className="box-body">
                                    <div className="flex items-center justify-between">
                                        <div>
                                            <h6 className="font-semibold text-info mb-3 text-[1rem]">Card fee unpaid</h6>
                                            <span className="text-[1.5625rem] font-semibold">12,240</span>
                        ...
                        <div className="xl:col-span-4 lg:col-span-4 md:col-span-4 sm:col-span-6 col-span-12">
                            <div className="box">
                                <div className="box-body">
                                    <div className="flex items-center justify-between">
                                        <div>
                                            <h6 className="font-semibold text-success mb-3 text-[1rem]">Daily Earn</h6>
                                            <span className="text-[1.5625rem] font-semibold">12,240</span>
                        ...
                        <div className="xl:col-span-4 lg:col-span-4 md:col-span-4 sm:col-span-6 col-span-12">
                            <div className="box">
                                <div className="box-body">
                                    <div className="flex items-center justify-between">
                                        <div>
                                            <h6 className="font-semibold text-danger mb-3 text-[1rem]">Daily Burn</h6>
                                            <span className="text-[1.5625rem] font-semibold">12,240</span>
                                        ...
                                        <table className="table table-hover whitespace-nowrap min-w-full">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th scope="col" className="text-start">Earn</th>
                                                ...
                                                <tr className="border-t border-inherit border-solid hover:bg-gray-100 dark:hover:bg-light dark:border-defaultborder/10">
                                                    <td>
                                                        <div className="flex items-center">
                                                            ...
                                                            <div className="font-semibold">Uttara</div>
                                                        </div>
                                                    </td>
                                                    <td>
                                                ...
                                                <tr className="border-t border-inherit border-solid hover:bg-gray-100 dark:hover:bg-light dark:border-defaultborder/10">
                                                    <td>
                                                        <div className="flex items-center">
                                                            ...
                                                            <div className="font-semibold">Mirpur 2</div>
                                                        </div>
                                                    </td>
                                                    <td>
                                                ...
                                                <tr className="border-t border-inherit border-solid hover:bg-gray-100 dark:hover:bg-light dark:border-defaultborder/10">
                                                    <td>
                                                        <div className="flex items-center">
                                                            ...
                                                            <div className="font-semibold">Gulshan
                                                            </div>
                                                        </div>
                                                    </td>
                                                    <td>
                                                ...
                                                <tr className="border-t border-inherit border-solid hover:bg-gray-100 dark:hover:bg-light dark:border-defaultborder/10">
                                                    <td>
                                                        <div className="flex items-center">
                                                            ...
                                                            <div className="font-semibold">Wari</div>
                                                        </div>
                                                    </td>
                                                    <td>
                                                ...
                                                <tr className="border-t border-inherit border-solid hover:bg-gray-100 dark:hover:bg-light dark:border-defaultborder/10">
                                                    <td className="border-bottom-0">
                                                        <div className="flex items-center">
                                                            ...
                                                            <div className="font-semibold">Bashundhara</div>
                                                        </div>
                                                    </td>
                                                    <td className="border-bottom-0">
                ...
                <div className="xl:col-span-5 col-span-12">
                    <div className="grid grid-cols-12 gap-x-6">
                                    ...
                                    <div className="grid grid-cols-12 justify-center">
                                        <div className="col-span-3 pe-0 text-center">
                                            <div className="sm:p-4  p-2 ">
                                                <span className="text-[#8c9097] dark:text-white/50 text-[0.6875rem]">Total</span>
                                                <span className="block text-[1rem] font-semibold">68.3%</span>
                                            </div>
                                        </div>
                                        <div className="col-span-3 px-0 text-center">
                                            <div className="sm:p-4 p-2">
                                                <span className="text-[#8c9097] dark:text-white/50 text-[0.6875rem]">Cash</span>
                                                <span className="block text-[1rem] font-semibold">17.68%</span>
                                            </div>
                                        </div>
                                        <div className="col-span-3 px-0 text-center">
                                            <div className="sm:p-4 p-2 ">
                                                <span className="text-[#8c9097] dark:text-white/50 text-[0.6875rem]">Cashless</span>
                                                <span className="block text-[1rem] font-semibold">10.5%</span>
                                            </div>
                                        </div>
                                        <div className="col-span-3 px-0 text-center">
                                            <div className="sm:p-4 p-2">
                                                <span className="text-[#8c9097] dark:text-white/50 text-[0.6875rem]">Online</span>
                        ...
                        <div className="xl:col-span-12 col-span-12">
                            <div className="box">
                                <div className="box-header justify-between">
                                    <div className="box-title">Monthly Report</div>
                                    <div className="hs-dropdown ti-dropdown">
                                        <Link to="#" className="px-2 font-normal text-[0.75rem] text-[#8c9097] dark:text-white/50"
                                            aria-expanded="false">
                                            View All<i className="ri-arrow-down-s-line align-middle ms-1 inline-block"></i>
                                ...
                                <table className="table table-hover whitespace-nowrap table-bordered min-w-full">
                                    <thead>
                                        <tr>
                                            ...
                                            <th scope="col" className="text-start">Points</th>
                                            <th scope="col" className="text-start">Location</th>
                                            <th scope="col" className="text-start">Goal Completed</th>
                                            <th scope="col" className="text-start">Visiting Outlate</th>
                                        </tr>
                                    </thead>
                                    <tbody>
